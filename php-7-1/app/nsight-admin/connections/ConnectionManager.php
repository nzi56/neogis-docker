...
class ConnectionManager
{
	...
	{
		return $this->byId( "neogis_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "neogis_at_localhost";
		$data["connName"] = "neogis at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;nsight;nsight@Nreca;;neogis;;1;6432"; //currently unused

		$this->_connectionsIdByName["neogis at localhost"] = "neogis_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "nsight";
		$data["ODBCPWD"] = "nsight@Nreca";
		$data["leftWrap"] = "\"";
		$data["rightWrap"] = "\"";
...
;
		...
		$connectionsData["neogis_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["config.stats_info"] = "neogis_at_localhost";
		$connectionsIds["config.layers_info"] = "neogis_at_localhost";
		$connectionsIds["config.layers_group"] = "neogis_at_localhost";

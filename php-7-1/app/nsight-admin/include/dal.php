...
class tDAL
{
	var $tblneogis_at_localhost_config_layers_group;
	var $tblneogis_at_localhost_config_layers_info;
	var $tblneogis_at_localhost_config_stats_info;
	var $tblneogis_at_localhost_public_refresh_tokens;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "layers_group", "varname" => "neogis_at_localhost_config_layers_group", "altvarname" => "layers_group", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
		$this->lstTables[] = array("name" => "layers_info", "varname" => "neogis_at_localhost_config_layers_info", "altvarname" => "layers_info", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
		$this->lstTables[] = array("name" => "stats_info", "varname" => "neogis_at_localhost_config_stats_info", "altvarname" => "stats_info", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
		$this->lstTables[] = array("name" => "refresh_tokens", "varname" => "neogis_at_localhost_public_refresh_tokens", "altvarname" => "refresh_tokens", "connId" => "neogis_at_localhost", "schema" => "public", "connName" => "neogis at localhost");
	}

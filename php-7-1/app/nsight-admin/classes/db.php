...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "neogis_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "layers_group", "varname" => "neogis_at_localhost_config_layers_group", "altvarname" => "layers_group", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
			$dalTables[$conn->connId][] = array("name" => "layers_info", "varname" => "neogis_at_localhost_config_layers_info", "altvarname" => "layers_info", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
			$dalTables[$conn->connId][] = array("name" => "stats_info", "varname" => "neogis_at_localhost_config_stats_info", "altvarname" => "stats_info", "connId" => "neogis_at_localhost", "schema" => "config", "connName" => "neogis at localhost");
			$dalTables[$conn->connId][] = array("name" => "refresh_tokens", "varname" => "neogis_at_localhost_public_refresh_tokens", "altvarname" => "refresh_tokens", "connId" => "neogis_at_localhost", "schema" => "public", "connName" => "neogis at localhost");
		}
	}

...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "config.stats_info" ] = array( "url" => "config_stats_info", "type" => 0 );
	$projectEntitiesReverse[ "config_stats_info" ] = "config.stats_info";
	$projectEntities[ "config.layers_info" ] = array( "url" => "config_layers_info", "type" => 0 );
	$projectEntitiesReverse[ "config_layers_info" ] = "config.layers_info";
	$projectEntities[ "config.layers_group" ] = array( "url" => "config_layers_group", "type" => 0 );
	$projectEntitiesReverse[ "config_layers_group" ] = "config.layers_group";
}

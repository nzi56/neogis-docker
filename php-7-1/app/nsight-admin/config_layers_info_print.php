...
require_once("include/config_layers_info_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "config_layers_info_print";
...
$page_layouts["config_layers_info_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "config.layers_info" );

...
require_once("include/config_layers_group_variables.php");





$layout = new TLayout("print_bootstrap", "DeliciousDeliciousGray", "MobileDeliciousGray");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "config_layers_group_print";
...
$page_layouts["config_layers_group_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "config.layers_group" );

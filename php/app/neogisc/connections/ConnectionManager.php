...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "neogisc_at_localhost";
		$data["connName"] = "neogis at localhost";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;localhost;postgres;mnzryv;;neogis;;1;6432"; //currently unused

		$this->_connectionsIdByName["neogis at localhost"] = "neogisc_at_localhost";
...
;
		...
		$connectionsData["neogisc_at_localhost"] = $data;

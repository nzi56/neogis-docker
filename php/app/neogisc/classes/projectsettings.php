...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "config.layers_info" ] = array( "url" => "layers_info", "type" => 0 );
	$projectEntitiesReverse[ "layers_info" ] = "config.layers_info";
	$projectEntities[ "config.layers_group" ] = array( "url" => "layers_group", "type" => 0 );
	$projectEntitiesReverse[ "layers_group" ] = "config.layers_group";
}
